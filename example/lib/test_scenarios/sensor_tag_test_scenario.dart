...
class SensorTagTestScenario {
  ...
  Future<void> runTestScenario() async {
    _peripheralTestOperations.connect()
        ...
        .then((_) => _peripheralTestOperations.readCharacteristicForPeripheral())
        .then((_) => _peripheralTestOperations.writeCharacteristicForService())
        .then((_) => _peripheralTestOperations.readCharacteristicForPeripheral())
        .then((_) => _peripheralTestOperations.writeCharacteristicForPeripheral())
        .then((_) => _peripheralTestOperations.readCharacteristicForPeripheral())
        .then((_) => _peripheralTestOperations.writeCharacteristic())
        .then((_) => _peripheralTestOperations.readCharacteristicForPeripheral())
